//This program toggles bewteen rotation and translation commands,based on calls to a service.
#include <ros/ros.h>
...
bool toggleForward(std_srvs::Empty::Request &req,std_srvs::Empty::Response &resp){
	forward = !forward;
	ROS_INFO_STREAM("Now_sending_"<<(forward?"forward":"rotate")<<"_commands.");
	return true;
	}
